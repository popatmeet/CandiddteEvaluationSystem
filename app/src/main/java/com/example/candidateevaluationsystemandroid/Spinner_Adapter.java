...
public class Spinner_Adapter extends ArrayAdapter<spinner_item> {

    private Context context;
    private ArrayList<spinner_item> list;
    private Spinner_Adapter myAdapter;
    private boolean isFromView = false;


    public Spinner_Adapter(@NonNull Context context, int resource , List<spinner_item> objects) {
        super(context, resource, objects);
        this.context = context;
        this.list = (ArrayList<spinner_item>) objects;
        this.myAdapter = this;
    }
